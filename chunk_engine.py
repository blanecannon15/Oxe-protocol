            ...
            response = client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": (
                        ...
                        "meu rei, véi, mano, bicho, rapaz), locais de Salvador. "
                        "Cada frase 8-15 palavras. "
                        "OBRIGATÓRIO usar elisões e contrações nativas da fala real: "
                        "tá, tô, tava, tão, cê, ocê, né, pro, pra, prum, pras, pros, "
                        "num, numa, nuns, dum, duma, cum, comigo, contigo, "
                        "to ligado, ta ligado, ce ligou, cadê, peraí, belê, "
                        "vai lá, vamo, bora, vambora, ó, ói, olha só, sei lá, "
                        "daqui a pouco, daí, aí, tipo, tipo assim, sacou, ligou, "
                        "memo, mermo, dimais, mai, tamém, já era, faz tempo, "
                        "fica de boa, sossegado, suave, tranquilo, de boas, "
                        "pode crer, com certeza, claro, lógico, verdade, "
                        "deixa eu, deixa pra lá, fala aí, manda ver, "
                        "que isso, que nada, imagina, qual é, e aí, "
                        "tô nem aí, tanto faz, sei não, acho que, parece que. "
...
def generate_chunks_for_word(word, word_id=None, count=4, db_path=DB_PATH):
    ...
    prompt = (
        ...
        f"  num, numa, dum, duma, cum, vamo, bora, vambora, ó, ói,\n"
    ...
    try:
        resp = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": (
                    "Tu é um linguista baiano especialista em aquisição de português brasileiro FALADO. "

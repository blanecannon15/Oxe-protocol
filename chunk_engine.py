            ...
            response = client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": (
                        ...
                        "trampo, correria, rolê, mó da hora, pô, cara, truta\n"
                        "CARIOCA: caralho, pô, mermão, parceiro, brother, papo reto, "
                        "sinistro, irado, responsa, cria, malandro, tá tranquilo, "
                        "na moral, suave na nave, chega junto\n"
                        "OBRIGATÓRIO elisões e contrações nativas da fala real: "
                        "tá, tô, tava, tão, cê, ocê, né, pro, pra, prum, pras, pros, "
                        "num, numa, dum, duma, cum, vamo, bora, vambora, "
                        "memo, mermo, dimais, mai, tamém, daí, aí, "
                        "tipo, tipo assim, sacou, ligou, sei lá, pode crer, "
                        "peraí, belê, cadê, fala aí, manda ver, tô nem aí, "
                        "já era, faz tempo, de boas, suave, sossegado. "
                        "NUNCA escreva 'está', 'estou', 'estava', 'estão', 'você', "
                        "'para o', 'para a', 'também', 'mesmo', 'demais', 'vamos' — "
...
def generate_chunks_for_word(word, word_id=None, count=4, db_path=DB_PATH):
    ...
    prompt = (
        ...
        f"- Frequentes no falar cotidiano brasileiro — o que a pessoa REALMENTE fala\n"
        f"- Naturais e conversacionais (não literários, não escritos)\n"
        f"- Úteis para automaticidade lexical\n"
        f"- Mistura gírias de todas regiões:\n"
        f"  BAIANO: oxe, massa, arretado, é mermo, véi, meu rei, barril\n"
        f"  PAULISTA: mano, mó, da hora, firmeza, tá ligado, é nóis, trampo, correria, rolê\n"
        f"  CARIOCA: mermão, parceiro, papo reto, sinistro, irado, na moral, suave na nave\n"
        f"- OBRIGATÓRIO usar elisões e formas faladas reais:\n"
        f"  tá, tô, tava, tão, cê, ocê, né, pro, pra, prum, pros, pras,\n"
        f"  num, numa, dum, duma, cum, vamo, bora, vambora,\n"
        f"  memo, mermo, dimais, mai, tamém, daí, aí, sacou, ligou,\n"
        f"  tipo, tipo assim, sei lá, faz tempo, já era, de boas, suave,\n"
        f"  pode crer, fala aí, manda ver, tô nem aí, tanto faz,\n"
        f"  peraí, belê, cadê, que isso, imagina, e aí, qual é.\n"
        f"  NUNCA 'está', 'estou', 'estava', 'você', 'para o', 'também', 'mesmo', 'vamos'.\n\n"
    ...
    try:
        resp = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": (
                    "Tu é um linguista brasileiro especialista em aquisição de português FALADO. "
                    "Mistura gírias de Salvador (oxe, massa, véi), São Paulo (mano, mó, firmeza, "
                    "tá ligado, é nóis, trampo) e Rio (mermão, papo reto, na moral, sinistro). "
                    "Tudo que cê gera deve soar como fala real de rua — com todas as elisões, "
                    "contrações e gírias que um brasileiro usa de verdade. "

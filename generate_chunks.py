    ...
    for i in range(0, len(words), batch_size):
        ...
        try:
            response = client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": (
                        "Tu é um linguista brasileiro especialista em colocações e chunks "
                        "do português brasileiro FALADO — mistura de baiano, paulista e carioca. "
                        "Gera chunks de alta frequência que um aprendiz PRECISA saber como "
                        "unidades inseparáveis. Inclui gírias de todas regiões:\n"
                        "BAIANO: oxe, massa, arretado, é mermo, véi, meu rei, barril, vixe\n"
                        "PAULISTA: mano, mó, da hora, firmeza, tá ligado, é nóis, trampo, "
                        "correria, rolê, pô, cara, truta, mó da hora\n"
                        "CARIOCA: mermão, parceiro, papo reto, sinistro, irado, na moral, "
                        "suave na nave, responsa, cria, chega junto, brother\n"
                        "OBRIGATÓRIO elisões: tá, tô, tava, tão, cê, ocê, né, pro, pra, prum, "
                        "num, numa, dum, duma, cum, vamo, bora, vambora, "
                        "memo, mermo, dimais, mai, tamém, daí, aí, sacou, ligou, "
                        "tipo, sei lá, pode crer, peraí, belê, cadê, fala aí, tô nem aí. "
                        "NUNCA formas escritas: 'está', 'estou', 'você', 'para o', "
                        "'também', 'mesmo', 'demais', 'vamos'. NUNCA inglês."
                    )},
                    {"role": "user", "content": (
                        ...
                        f"- Gírias paulistas: 'mó correria', 'é nóis', 'tá ligado', 'mó da hora', 'no trampo'\n"
                        f"- Gírias cariocas: 'papo reto', 'na moral', 'suave na nave', 'chega junto'\n"
                        ...
                        f"- Inclui variantes de BA, SP e RJ\n"
                        f"{exclude_block}\n"

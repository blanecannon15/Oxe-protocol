            ...
            response = client.chat.completions.create(
                ...
                messages=[
                    ...
                    {"role": "user", "content": (
                        ...
                        f"- Expressões fixas: 'por causa de', 'na hora de', 'ao invés de'\n"
                        f"- Gírias baianas: 'massa demais', 'é mermo', 'tá de boa'\n"
                        f"- Marcadores discursivos: 'tipo assim', 'sabe como é', 'aí né'\n"
                        f"- Verbo + preposição: 'pensar em', 'gostar de', 'lidar com'\n\n"
                        f"REGRAS:\n"
